...
useEffect(() => {
    console.log("DashBoarding is being loaded");
...
return (
    <>
    <UserPost onPost={loadPosts}/>
    <Button mx="50px" py="5" size="sm" onClick={loadPosts} ref={buttonRef}>Refresh</Button>
